...
package com.isg245.materialdaterangepicker.date;
...
public class DatePickerDialog extends DialogFragment implements
        OnClickListener, com.isg245.materialdaterangepicker.date.DatePickerController {
    ...
    private com.isg245.materialdaterangepicker.date.AccessibleDateAnimator mAnimator;
    ...
    private com.isg245.materialdaterangepicker.date.DayPickerView mDayPickerView;
    private com.isg245.materialdaterangepicker.date.YearPickerView mYearPickerView;
    ...
    private com.isg245.materialdaterangepicker.date.SimpleDayPickerView mDayPickerViewEnd;
    private com.isg245.materialdaterangepicker.date.YearPickerView mYearPickerViewEnd;
    private com.isg245.materialdaterangepicker.date.AccessibleDateAnimator mAnimatorEnd;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mDayPickerView = new com.isg245.materialdaterangepicker.date.SimpleDayPickerView(activity, this);
        mYearPickerView = new com.isg245.materialdaterangepicker.date.YearPickerView(activity, this);
        ...
        mAnimator = (com.isg245.materialdaterangepicker.date.AccessibleDateAnimator) view.findViewById(R.id.animator);
        mAnimatorEnd = (com.isg245.materialdaterangepicker.date.AccessibleDateAnimator) view.findViewById(R.id.animator_end);
        ...
        tabHost.setOnTabChangedListener(new TabHost.OnTabChangeListener() {
            ...
            public void onTabChanged(String tabId) {
                com.isg245.materialdaterangepicker.date.MonthAdapter.CalendarDay calendarDay;
                if(tabId=="start"){
                    calendarDay = new com.isg245.materialdaterangepicker.date.MonthAdapter.CalendarDay(mCalendar.getTimeInMillis());
                    mDayPickerView.goTo(calendarDay,true,true,false);
                }
                else{
                    calendarDay = new com.isg245.materialdaterangepicker.date.MonthAdapter.CalendarDay(mCalendarEnd.getTimeInMillis());
     ...
     */
    @SuppressWarnings("unused")
    public void setMinDateEnd(Calendar calendar) {
...
//        updatePickers();
    ...
    @Override
    public com.isg245.materialdaterangepicker.date.MonthAdapter.CalendarDay getSelectedDay() {
        if (tabHost.getCurrentTab() == 0) {
            return new com.isg245.materialdaterangepicker.date.MonthAdapter.CalendarDay(mCalendar);
        } else {
            return new com.isg245.materialdaterangepicker.date.MonthAdapter.CalendarDay(mCalendarEnd);
        }
    }
